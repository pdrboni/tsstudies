...
function outroDecorator2(param1: string) {
  return function (targ: Constructor) {
    console.log('Sou o terceiro decorador')
    return targ;
  }
}
...
@outroDecorator2('param decorador 2')   // vai passar terceiro por esse decorator
@inverteNomeECor('Value1', 'Value2')    // vai passar segundo por esse decorator
@outroDecorator                         // vai passar primeiro por esse decorator
export class Animal {
